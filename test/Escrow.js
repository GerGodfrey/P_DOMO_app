...
describe('Escrow', () => {
    ...
    beforeEach(async () => {
        // Setup accounts
        [buyer, seller, inspector, lender,second_buyer] = await ethers.getSigners()
    ...
    describe ('Deployment', () => {
        ...
        it('Returns NFT address', async() => {
            const result = await escrow_rs_1.nftAddress()
    ...
    describe ('Deposits', () => {
        ...
        it ('Updates contract balances', async () => {
            ...
            // const transaction2 = await escrow_rs_1.connect(buyer).depositEarnest(2, {value: tokens(5)})
            // await transaction2.wait()
    ...
    describe ('Inspection', () => {
        ...
        it ('Updates inspection status', async () => {
            const transaction = await escrow_rs_1.connect(inspector).updateInspectionStatus(1,true)
            await transaction.wait()
            const result = await escrow_rs_1.inspectionPassed(1)
            expect(result).to.be.equal(true)
        })
    ...
    describe ('Sale', () => {
        beforeEach(async () => {
            ...
            transaction = await escrow_rs_1.connect(inspector).updateInspectionStatus(1,true)
            await transaction.wait()
        ...
        it('Updates ownership - Second NFT', async () => {
            expect(await real_estate_1.ownerOf(2)).to.not.equal(second_buyer.address)
        })
